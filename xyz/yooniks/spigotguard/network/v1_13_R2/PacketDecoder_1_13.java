...
public class PacketDecoder_1_13 extends PacketDecoder
{
    ...
    public PacketDecoder_1_13(final PacketInjector injector, final User user) {
        super(injector);
        ...
        if (packet0.getClass().getSimpleName().equals("PacketPlayInWindowClick")) {
            ...
            try {
                ...
                if (inventoryView != null) {
                    ...
                    if (slot >= maxSlots && PacketDecoder_1_13.LIMITATION != null) {
            ...
            final BlockPosition position = p3.b();
    ...
    private LimitablePacket hasReachedLimit(final String packetName) {
        if (!PacketDecoder_1_13.LIMITATION.isLimitable(packetName)) {
            return null;
        }
        final LimitablePacket limitablePacket = PacketDecoder_1_13.LIMITATION.getLimit(packetName);
                ...
                if (properties.hasKey("textures")) {
                    ...
                    for (int i = 0; i < textures.size(); ++i) {
                        ...
                        if (entry.hasKey("Value")) {
                            ...
                            final Matcher matcher = PacketDecoder_1_13.URL_MATCHER.matcher(decoded);
                            while (matcher.find()) {
